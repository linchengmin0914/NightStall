...
import com.lcm.dao.business.Y23UserCartDao;
...
@Service
public class Y23UserCartService extends BaseService {
	@Autowired
	private Y23UserCartDao dao;
	
	public ResponseInfo add(Y23UserCart entity) {
	...
	public ResponseInfo update(Y23UserCart entity) {
		ResponseInfo responseInfo = null;
	...
	public ResponseInfo delete(Long id) {
		ResponseInfo responseInfo = null;
		Y23UserCart entity = new Y23UserCart();
		entity.setId(id);
	...
	public Y23UserCart getDetail(Long id) {
		return dao.get(id);
	}
	...
	public List<Y23UserCart> getList(Map param) {
