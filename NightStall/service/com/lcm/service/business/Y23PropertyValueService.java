...
import com.lcm.dao.business.Y23PropertyValueDao;
...
@Service
public class Y23PropertyValueService extends BaseService {
	@Autowired
	private Y23PropertyValueDao dao;
	
	public ResponseInfo add(Y23PropertyValue entity) {
	...
	public ResponseInfo update(Y23PropertyValue entity) {
		ResponseInfo responseInfo = null;
	...
	public ResponseInfo delete(Long id) {
		ResponseInfo responseInfo = null;
		Y23PropertyValue entity = new Y23PropertyValue();
		entity.setId(id);
	...
	public List<Y23PropertyValue> getList() {
		return dao.select();
	}

	public Y23PropertyValue getDetail(Long id) {
		return dao.get(id);
	}
	...
	public List<Y23PropertyValue> getList(Map param) {
