...
import com.lcm.dao.business.Y23UserAddressDao;
...
@Service
public class Y23UserAddressService extends BaseService {
	@Autowired
	private Y23UserAddressDao dao;
	
	public ResponseInfo add(Y23UserAddress entity) {
	...
	public ResponseInfo update(Y23UserAddress entity) {
		ResponseInfo responseInfo = null;
	...
	public ResponseInfo delete(Long id) {
		ResponseInfo responseInfo = null;
		Y23UserAddress entity = new Y23UserAddress();
		entity.setId(id);
	...
	public Y23UserAddress getDetail(Long id) {
		return dao.get(id);
	}
	...
	public List<Y23UserAddress> getList(Map param) {
