...
import com.lcm.dao.business.Y23UserOrderitemDao;
...
@Service
public class Y23UserOrderitemService extends BaseService {
	@Autowired
	private Y23UserOrderitemDao dao;
	
	public ResponseInfo add(Y23UserOrderitem entity) {
	...
	public ResponseInfo update(Y23UserOrderitem entity) {
		ResponseInfo responseInfo = null;
	...
	public ResponseInfo delete(Long id) {
		ResponseInfo responseInfo = null;
		Y23UserOrderitem entity = new Y23UserOrderitem();
		entity.setId(id);
	...
	public List<Y23UserOrderitem> getList() {
		return dao.select();
	}

	public Y23UserOrderitem getDetail(Long id) {
		return dao.get(id);
	}
	...
	public List<Y23UserOrderitem> getList(Map param) {
