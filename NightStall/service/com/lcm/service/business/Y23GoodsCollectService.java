...
import com.lcm.dao.business.Y23GoodsCollectDao;
...
@Service
public class Y23GoodsCollectService extends BaseService {
	@Autowired
	private Y23GoodsCollectDao dao;
	
	public ResponseInfo add(Y23GoodsCollect entity) {
	...
	public ResponseInfo update(Y23GoodsCollect entity) {
		ResponseInfo responseInfo = null;
	...
	public ResponseInfo delete(Long id) {
		ResponseInfo responseInfo = null;
		Y23GoodsCollect entity = new Y23GoodsCollect();
		entity.setId(id);
	...
	public Y23GoodsCollect getDetail(Long id) {
		return dao.get(id);
	}
	...
	public List<Y23GoodsCollect> getList(Map param) {
