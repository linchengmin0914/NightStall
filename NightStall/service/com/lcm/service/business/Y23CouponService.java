...
import com.lcm.dao.business.Y23CouponDao;
...
@Service
public class Y23CouponService extends BaseService {
	@Autowired
	private Y23CouponDao dao;
	
	public ResponseInfo add(Y23Coupon entity) {
	...
	public ResponseInfo update(Y23Coupon entity) {
		ResponseInfo responseInfo = null;
	...
	public ResponseInfo delete(Long id) {
		ResponseInfo responseInfo = null;
		Y23Coupon entity = new Y23Coupon();
		entity.setId(id);
	...
	public Y23Coupon getDetail(Long id) {
		return dao.get(id);
	}
	...
	public List<Y23Coupon> getList(Map param) {
