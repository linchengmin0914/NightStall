...
import com.lcm.dao.business.Y23BrandDao;
...
@Service
public class Y23BrandService extends BaseService {
	@Autowired
	private Y23BrandDao dao;
	
	public ResponseInfo add(Y23Brand entity) {
	...
	public ResponseInfo update(Y23Brand entity) {
		ResponseInfo responseInfo = null;
	...
	public List<Y23Brand> getList() {
		return dao.select();
	}

	public Y23Brand getDetail(Long id) {
		return dao.get(id);
	}
	...
	public List<Y23Brand> getList(Map param) {
