...
import com.lcm.dao.business.Y23CouponGoodsDao;
...
@Service
public class Y23CouponGoodsService extends BaseService {
	@Autowired
	private Y23CouponGoodsDao dao;
	
	public ResponseInfo add(Y23CouponGoods entity) {
	...
	public ResponseInfo update(Y23CouponGoods entity) {
		ResponseInfo responseInfo = null;
	...
	public ResponseInfo delete(Long id) {
		ResponseInfo responseInfo = null;
		Y23CouponGoods entity = new Y23CouponGoods();
		entity.setId(id);
	...
	public List<Y23CouponGoods> getList() {
		return dao.select();
	}

	public Y23CouponGoods getDetail(Long id) {
		return dao.get(id);
	}
	...
	public List<Y23CouponGoods> getList(Map param) {
