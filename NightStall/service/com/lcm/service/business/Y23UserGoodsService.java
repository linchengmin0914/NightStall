...
import com.lcm.dao.business.Y23UserGoodsDao;
...
@Service
public class Y23UserGoodsService extends BaseService {
	@Autowired
	private Y23UserGoodsDao dao;
	
	public ResponseInfo add(Y23UserGoods entity) {
	...
	public ResponseInfo update(Y23UserGoods entity) {
		ResponseInfo responseInfo = null;
	...
	public ResponseInfo delete(Long id) {
		ResponseInfo responseInfo = null;
		Y23UserGoods entity = new Y23UserGoods();
		entity.setId(id);
	...
	public List<Y23UserGoods> getList() {
		return dao.select();
	}

	public Y23UserGoods getDetail(Long id) {
		return dao.get(id);
	}
	...
	public List<Y23UserGoods> getList(Map param) {
