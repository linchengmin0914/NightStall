...
import com.lcm.dao.business.Y23UserOrdersDao;
...
@Service
public class Y23UserOrdersService extends BaseService {
	@Autowired
	private Y23UserOrdersDao dao;
	
	public ResponseInfo add(Y23UserOrders entity) {
	...
	public ResponseInfo update(Y23UserOrders entity) {
		ResponseInfo responseInfo = null;
	...
	public ResponseInfo delete(Long id) {
		ResponseInfo responseInfo = null;
		Y23UserOrders entity = new Y23UserOrders();
		entity.setId(id);
	...
	public Y23UserOrders getDetail(Long id) {
		return dao.get(id);
	}
	...
	public List<Y23UserOrders> getList(Map param) {
