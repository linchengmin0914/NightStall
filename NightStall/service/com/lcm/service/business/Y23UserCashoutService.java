...
import com.lcm.dao.business.Y23UserCashoutDao;
...
@Service
public class Y23UserCashoutService extends BaseService {
	@Autowired
	private Y23UserCashoutDao dao;
	
	public ResponseInfo add(Y23UserCashout entity) {
	...
	public ResponseInfo update(Y23UserCashout entity) {
		ResponseInfo responseInfo = null;
	...
	public ResponseInfo delete(Long id) {
		ResponseInfo responseInfo = null;
		Y23UserCashout entity = new Y23UserCashout();
		entity.setId(id);
	...
	public List<Y23UserCashout> getList() {
		return dao.select();
	}

	public Y23UserCashout getDetail(Long id) {
		return dao.get(id);
	}
	...
	public List<Y23UserCashout> getList(Map param) {
