...
import com.lcm.dao.business.Y23UserCommissionDao;
...
@Service
public class Y23UserCommissionService extends BaseService {
	@Autowired
	private Y23UserCommissionDao dao;
	
	public ResponseInfo add(Y23UserCommission entity) {
	...
	public ResponseInfo update(Y23UserCommission entity) {
		ResponseInfo responseInfo = null;
	...
	public ResponseInfo delete(Long id) {
		ResponseInfo responseInfo = null;
		Y23UserCommission entity = new Y23UserCommission();
		entity.setId(id);
	...
	public List<Y23UserCommission> getList() {
		return dao.select();
	}

	public Y23UserCommission getDetail(Long id) {
		return dao.get(id);
	}
	...
	public List<Y23UserCommission> getList(Map param) {
