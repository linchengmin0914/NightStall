...
import com.lcm.dao.business.Y23SysBannerDao;
...
@Service
public class Y23SysBannerService extends BaseService {
	@Autowired
	private Y23SysBannerDao dao;
	
	public ResponseInfo add(Y23SysBanner entity) {
	...
	public ResponseInfo update(Y23SysBanner entity) {
		ResponseInfo responseInfo = null;
	...
	public ResponseInfo delete(Long id) {
		ResponseInfo responseInfo = null;
		Y23SysBanner entity = new Y23SysBanner();
		entity.setId(id);
	...
	public List<Y23SysBanner> getList(Integer page, Integer pageSize) {
	...
	public Y23SysBanner getDetail(Long id) {
		return dao.get(id);
	}
	...
	public List<Y23SysBanner> getList(Map param) {
		return dao.selectParam(param);
	}
}
