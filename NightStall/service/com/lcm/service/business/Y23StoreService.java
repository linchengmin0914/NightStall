...
import com.lcm.dao.business.Y23StoreDao;
...
@Service
public class Y23StoreService extends BaseService {
	@Autowired
	private Y23StoreDao dao;
	
	public ResponseInfo add(Y23Store entity) {
	...
	public ResponseInfo update(Y23Store entity) {
		ResponseInfo responseInfo = null;
	...
	public List<Y23Store> getList() {
		return dao.select();
	}

	public Y23Store getDetail(Long id) {
		return dao.get(id);
	}
	...
	public List<Y23Store> getList(Map param) {
