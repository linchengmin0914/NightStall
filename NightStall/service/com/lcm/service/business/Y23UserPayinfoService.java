...
import com.lcm.dao.business.Y23UserPayinfoDao;
...
@Service
public class Y23UserPayinfoService extends BaseService {
	@Autowired
	private Y23UserPayinfoDao dao;
	
	public ResponseInfo add(Y23UserPayinfo entity) {
	...
	public ResponseInfo update(Y23UserPayinfo entity) {
		ResponseInfo responseInfo = null;
	...
	public ResponseInfo delete(Long id) {
		ResponseInfo responseInfo = null;
		Y23UserPayinfo entity = new Y23UserPayinfo();
		entity.setId(id);
	...
	public List<Y23UserPayinfo> getList() {
		return dao.select();
	}

	public Y23UserPayinfo getDetail(Long id) {
		return dao.get(id);
	}
	...
	public List<Y23UserPayinfo> getList(Map param) {
