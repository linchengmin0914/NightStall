...
import com.lcm.dao.business.Y23PropertyNameDao;
...
@Service
public class Y23PropertyNameService extends BaseService {
	@Autowired
	private Y23PropertyNameDao dao;
	
	public ResponseInfo add(Y23PropertyName entity) {
	...
	public ResponseInfo update(Y23PropertyName entity) {
		ResponseInfo responseInfo = null;
	...
	public ResponseInfo delete(Long id) {
		ResponseInfo responseInfo = null;
		Y23PropertyName entity = new Y23PropertyName();
		entity.setId(id);
	...
	public List<Y23PropertyName> getList() {
		return dao.select();
	}

	public Y23PropertyName getDetail(Long id) {
		return dao.get(id);
	}
	...
	public List<Y23PropertyName> getList(Map param) {
