...
import com.lcm.dao.business.Y23UserCommentDao;
...
@Service
public class Y23UserCommentService extends BaseService {
	@Autowired
	private Y23UserCommentDao dao;
	
	public ResponseInfo add(Y23UserComment entity) {
	...
	public ResponseInfo update(Y23UserComment entity) {
		ResponseInfo responseInfo = null;
	...
	public ResponseInfo delete(Long id) {
		ResponseInfo responseInfo = null;
		Y23UserComment entity = new Y23UserComment();
		entity.setId(id);
	...
	public Y23UserComment getDetail(Long id) {
		return dao.get(id);
	}
	...
	public List<Y23UserComment> getList(Map param) {
