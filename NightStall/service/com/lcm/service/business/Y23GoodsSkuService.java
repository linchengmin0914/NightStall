...
import com.lcm.dao.business.Y23GoodsSkuDao;
...
@Service
public class Y23GoodsSkuService extends BaseService {
	@Autowired
	private Y23GoodsSkuDao dao;
	
	public ResponseInfo add(Y23GoodsSku entity) {
	...
	public ResponseInfo update(Y23GoodsSku entity) {
		ResponseInfo responseInfo = null;
	...
	public ResponseInfo delete(Long id) {
		ResponseInfo responseInfo = null;
		Y23GoodsSku entity = new Y23GoodsSku();
		entity.setId(id);
	...
	public List<Y23GoodsSku> getList() {
		return dao.select();
	}

	public Y23GoodsSku getDetail(Long id) {
		return dao.get(id);
	}
	...
	public List<Y23GoodsSku> getList(Map param) {
