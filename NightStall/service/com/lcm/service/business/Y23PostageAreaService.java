...
import com.lcm.dao.business.Y23PostageAreaDao;
...
@Service
public class Y23PostageAreaService extends BaseService {
	@Autowired
	private Y23PostageAreaDao dao;
	
	public ResponseInfo add(Y23PostageArea entity) {
	...
	public ResponseInfo update(Y23PostageArea entity) {
		ResponseInfo responseInfo = null;
	...
	public ResponseInfo delete(Long id) {
		ResponseInfo responseInfo = null;
		Y23PostageArea entity = new Y23PostageArea();
		entity.setId(id);
	...
	public List<Y23PostageArea> getList() {
		return dao.select();
	}

	public Y23PostageArea getDetail(Long id) {
		return dao.get(id);
	}
	...
	public List<Y23PostageArea> getList(Map param) {
