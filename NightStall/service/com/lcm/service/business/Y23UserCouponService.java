...
import com.lcm.dao.business.Y23UserCouponDao;
...
@Service
public class Y23UserCouponService extends BaseService {
	@Autowired
	private Y23UserCouponDao dao;
	
	public ResponseInfo add(Y23UserCoupon entity) {
	...
	public ResponseInfo update(Y23UserCoupon entity) {
		ResponseInfo responseInfo = null;
	...
	public ResponseInfo delete(Long id) {
		ResponseInfo responseInfo = null;
		Y23UserCoupon entity = new Y23UserCoupon();
		entity.setId(id);
	...
	public Y23UserCoupon getDetail(Long id) {
		return dao.get(id);
	}
	...
	public List<Y23UserCoupon> getList(Map param) {
