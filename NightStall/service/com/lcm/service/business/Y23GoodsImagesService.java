...
import com.lcm.dao.business.Y23GoodsImagesDao;
...
@Service
public class Y23GoodsImagesService extends BaseService {
	@Autowired
	private Y23GoodsImagesDao dao;
	
	public ResponseInfo add(Y23GoodsImages entity) {
	...
	public ResponseInfo update(Y23GoodsImages entity) {
		ResponseInfo responseInfo = null;
	...
	public ResponseInfo delete(Long id) {
		ResponseInfo responseInfo = null;
		Y23GoodsImages entity = new Y23GoodsImages();
		entity.setId(id);
	...
	public List<Y23GoodsImages> getList() {
		return dao.select();
	}

	public Y23GoodsImages getDetail(Long id) {
		return dao.get(id);
	}
	...
	public List<Y23GoodsImages> getList(Map param) {
