...
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="form-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-8">
				<input type="text" class="input-text" value="${entity.title}" placeholder="" id="title" name="title" datatype="*1-100" nullmsg="属性值不能为空！" >
			</div>
			<div class="col-2"> </div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-8">
				<input type="text" class="input-text" value="${entity.value}" placeholder="" id="value" name="value" datatype="*1-100" nullmsg="属性值不能为空！" >
			</div>
			<div class="col-2"> </div>
		</div>
...
$(function(){
	 ...
	 $("#form-add").Validform({  
        ...
        beforeSubmit:function(){  
            ajaxForm("${ctx}/admin/goods/propertyvalue/update/done.html", function(data) {
				if(data.resCode == 1) {
