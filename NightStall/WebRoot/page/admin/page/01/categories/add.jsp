...
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="form-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-8">
				<input type="text" class="input-text" value="" placeholder="" id="cateName" name="cateName" datatype="*1-100" nullmsg="分类名称不能为空！" >
			</div>
			<div class="col-2"> </div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-8">
				<select class="js-example-templating js-states form-control" style="width: 100%;" multiple="multiple" id="sel_3">
			        <option value="images/ico/01.png">图标1</option>
			        <option value="images/ico/02.png">图标2</option>
			        <option value="images/ico/03.png">图标3</option>
			        <option value="images/ico/04.png">图标4</option>
			        <option value="images/ico/05.png">图标5</option>
			        <option value="images/ico/06.png">图标6</option>
			        <option value="images/ico/07.png">图标7</option>
			        <option value="images/ico/08.png">图标8</option>
			        <option value="images/ico/09.png">图标9</option>
			        <option value="images/ico/10.png">图标10</option>
			        <option value="images/ico/11.png">图标11</option>
			        <option value="images/ico/12.png">图标12</option>
			        <option value="images/ico/13.png">图标13</option>
			        <option value="images/ico/14.png">图标14</option>
			        <option value="images/ico/15.png">图标15</option>
			        <option value="images/ico/16.png">图标16</option>
			        <option value="images/ico/17.png">图标17</option>
			    </select>
			</div>
			<div class="col-2"> </div>
		</div>
...
$(function(){
	 $("#form-add").Validform({  
        ...
        beforeSubmit:function(){  
            ajaxForm("${ctx}/admin/01/goods/categories/add/done.html", function(data) {
				if(data.resCode == 1) {
