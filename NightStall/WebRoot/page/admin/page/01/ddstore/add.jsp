...
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="form-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-8">
				<input type="text" class="input-text" value="" placeholder="" id="no" name="no" datatype="*1-100" nullmsg="门店编号不能为空！" >
			</div>
			<div class="col-2"> </div>
		</div>
...
$(function(){
	 $("#form-add").Validform({  
        ...
        beforeSubmit:function(){  
            ajaxForm("${ctx}/admin/01/order/ddstore/add/done.html", function(data) {
				if(data.resCode == 1) {
