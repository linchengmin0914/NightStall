...
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="form-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-8">
				<input type="text" class="input-text" value="${entity.opentime}" placeholder="" id="opentime" name="opentime" datatype="*1-100" nullmsg="营业时间不能为空！" >
			</div>
			<div class="col-2"> </div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-8">
				<input type="text" class="input-text" value="${entity.minDeliveryPrice}" placeholder="" id="minDeliveryPrice" name="minDeliveryPrice" datatype="*1-100" nullmsg="起送价不能为空！" >
			</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-8">
				<input type="text" class="input-text" value="${entity.deliveryTime}" placeholder="" id="deliveryTime" name="deliveryTime" datatype="*1-100" nullmsg="派送时间不能为空！" >
			</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-8">
				<input type="text" class="input-text" value="${entity.distanceFormat}" placeholder="" id="distanceFormat" name="distanceFormat" datatype="*1-100" nullmsg="派送距离不能为空！" >
			</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-8">
				<input type="text" class="input-text" value="${entity.overall}" placeholder="" id="overall" name="overall" datatype="*1-100" nullmsg="推荐指数不能为空！" >
			</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-8">
				<input type="text" class="input-text" value="${entity.msaleNum}" placeholder="" id="msaleNum" name="msaleNum" datatype="*1-100" nullmsg="销售单数不能为空！" >
			</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-8">
				<textarea id="summary" name="summary" cols="" rows="" class="textarea"  placeholder="请输入门店的描述信息..." dragonfly="true" onKeyUp="textarealength(this,200)">${entity.summary}</textarea>
		...
		<div class="row cl">
			...
			<div class="formControls col-8">
				<input type="text" class="input-text" value="${entity.address}" placeholder="" id="keyword" name="address" datatype="*1-100" nullmsg="门店地址不能为空！" oninput="getSuggestions()"/>
		...
		<div class="row cl">
			...
			<div class="formControls col-8">
				<input type="text" class="input-text" value="${entity.latitude}" placeholder="" id="latitude" name="latitude" readonly="readonly"/>
			</div>
			<div class="col-2"> </div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-8">
				<input type="text" class="input-text" value="${entity.longitude}" placeholder="" id="longitude" name="longitude" readonly="readonly"/>
			</div>
			<div class="col-2"> </div>
		</div>
...
var map = new TMap.Map('container', {
  zoom: 14,
  center: new TMap.LatLng(${entity.latitude},${entity.longitude}),
});
...
var markers = new TMap.MultiMarker({
    ...
    geometries: [{
        "id": 'demo',
        "styleId": 'markers',
        "position": new TMap.LatLng(${entity.latitude},${entity.longitude}),
        "properties": {
            "title": "marker"
        }
    }]
...
$(function(){
	 ...
	 $("#form-add").Validform({  
        ...
        beforeSubmit:function(){  
            ajaxForm("${ctx}/admin/01/store/update/done.html", function(data) {
				if(data.resCode == 1) {
