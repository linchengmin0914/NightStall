	...
	<form action="" method="post" class="form form-horizontal" id="form-add">
		<div class="row cl">
			...
			<div class="formControls col-8">
				<input type="text" class="input-text" value="${entity.title}" placeholder="" id="title" name="title" datatype="*1-100" nullmsg="标题不能为空！" >
			</div>
			<div class="col-2"> </div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-8">
				...
				<img src="${ctx}/${entity.cover}" id="img0" style="height: 100px;">
				</c:when>
				<c:otherwise>
		...
		<div class="row cl">
			...
			<div class="formControls col-8">
				<select class="js-example-templating js-states form-control" style="width: 100%;" multiple="multiple" id="sel_3" name="enCover">
			        <option value="images/banner/bg01.png" <c:if test="${'images/banner/bg01.png' eq entity.enCover}">selected="selected"</c:if>>电商促销海报背景</option>
			        <option value="images/banner/bg02.png" <c:if test="${'images/banner/bg02.png' eq entity.enCover}">selected="selected"</c:if>>祥云红色喜庆中国风海报背景</option>
			        <option value="images/banner/bg03.png" <c:if test="${'images/banner/bg03.png' eq entity.enCover}">selected="selected"</c:if>>兔年大吉红色喜庆春节元旦海报背景</option>
			        <option value="images/banner/bg04.png" <c:if test="${'images/banner/bg04.png' eq entity.enCover}">selected="selected"</c:if>>红色中国风元旦节日海报背景</option>
			    </select>
			</div> 
			<div class="col-2"> </div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-8">
				<input type="text" class="input-text" value="${entity.url }" placeholder="请输入点击活动要跳转的地址" id="url" name="url" >
			</div>
			<div class="col-2"> </div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-8">
				<script id="summary" type="text/plain" name="summary" style="height:300px;">${entity.summary}</script>
			</div>
			<div class="col-2" style="color: #999;font-size: 9px;">建议控制在20个字之内，以免影响美观</div>
		</div>
		--%>
		...
		<div class="row cl">
			...
			<div class="formControls col-8">
				<textarea id="summary" name="summary" cols="" rows="" class="textarea"  placeholder="请输入活动的描述信息..." dragonfly="true" onKeyUp="textarealength(this,200)">${entity.summary }</textarea>
	...
	content = UE.getEditor('content',{savePath:['upload']});
	 ...
	 $("#form-add").Validform({  
        ...
        beforeSubmit:function(){  
            ajaxForm("${ctx}/admin/01/sys/banner/update/done.html", function(data) {
				if(data.resCode == 1) {
