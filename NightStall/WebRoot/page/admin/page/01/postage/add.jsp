...
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="form-add">
		...
		<div id="postage3" style="display:none;margin: 10px 0;">
			<div class="row cl">
				<label class="form-label col-2"><span class="c-red">*</span>包邮地区：</label>
				<div class="formControls col-10">
					<div id="cityDuoXuan" style="width:98%;overflow: hidden;" data-id=""></div>
				</div>
				<div class="col-2"> </div>
			</div>
		</div>
		...
		<div id="postage2" style="display:none;margin: 10px 0;">
			...
			<div class="formControls col-10">
				<dl class="permission-list" style="border: none;">
					<dt>
						<label>默认运费</label>
						<input type="text" class="input-text" value="" placeholder="" id="firstNum" style="width: 70px;"/>
						<label>件内，</label>
						<input type="text" class="input-text" value="" placeholder="" id="firstPrice" style="width: 70px;"/>
						<label>元，</label>
						<label>每增加</label>
						<input type="text" class="input-text" value="" placeholder="" id="continueNum" style="width: 70px;"/>
						<label>件，</label>
						<label>增加运费</label>
						<input type="text" class="input-text" value="" placeholder="" id="continuePrice" style="width: 70px;"/>
						<label>元</label>
					</dt>
				</dl>
				<dl class="permission-list" style="border: none;">
	...
	$('#cityDuoXuan').hsCheckData({
	 ...
	 $("#form-add").Validform({  
        ...
        beforeSubmit:function(){  
        	...
        	$.ajax({
                type: "POST",
                url:"${ctx}/admin/01/postage/add/done.html",
