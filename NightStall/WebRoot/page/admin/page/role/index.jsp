...
<div class="pd-20" style="padding-top: 10px;">
	<div class="text-c row">
		<label class="form-label col-1" style="line-height: 30px;">角色名称：</label>
		<div class="col-3">
			<input type="text" class="input-text" value="" placeholder="输入角色名称" id="name">
		</div>
		<div class="col-1">
		<button type="button" class="btn btn-success" onclick="search();"><i class="Hui-iconfont">&#xe665;</i> 搜角色</button>
	...
	<div class="cl pd-5 bg-1 bk-gray mt-40 mb-10 row"> 
		<span class="l">
			...
			<a href="javascript:;" onclick="add('添加角色','${ctx}/admin/role/add.html','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加角色</a>
		</span> 
	</div>
    ...
    table = $(".table-sort").dataTable({
        ...
        columns: [
            ...
            { "data": "createTime" },
            {
				...
				className : "nosort",
				render : function(data, type, full, meta) {
		        	html = '<a title="编辑" href="javascript:;" onclick="edit(\'角色编辑\',\'${ctx}/admin/role/update.html?id=' + full.id + '\',\'1\',\'800\',\'500\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> ' +
