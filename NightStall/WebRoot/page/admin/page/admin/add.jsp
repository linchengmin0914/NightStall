	...
	<form action="" method="post" class="form form-horizontal" id="form-add">
		<div class="row cl">
			...
			<div class="formControls col-8">
				<input type="text" class="input-text" value="" placeholder="" id="nickname" name="nickname" datatype="*1-100" nullmsg="账号不能为空！" >
			</div>
			<div class="col-2"> </div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-8">
				<input type="password" class="input-text" value="" placeholder="" id="passwd" name="passwd" datatype="*1-100" nullmsg="密码不能为空！" >
			</div>
			<div class="col-2"> </div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-8">
				...
				<select name="storeId" class="select">
					...
					<option value="${store.id}">${store.titile}</option>
					</c:forEach>
				</select>
				</span>
			</div>
...
$(function(){
	 ...
	 $("#form-add").Validform({  
        ...
        beforeSubmit:function(){  
            ajaxForm("${ctx}/admin/admin/add/done.html", function(data) {
				if(data.resCode == 1) {
