...
(function () {
    ...
    var localhostPaht = curWwwPath.substring(0, pos); //获取带"/"的项目名，如：/ixunkangBD3.0
    ...
    window.UEDITOR_CONFIG = {
		maximumWords:16777215,
    	
        //为编辑器实例添加一个路径，这个不能被注释
        UEDITOR_HOME_URL : URL

        //图片上传配置区
        ,imageUrl:rootPath+"/uploadImages.do"             //图片上传提交地址
...
//        ,snapscreenServerPort: location.port                                   //屏幕截图的server端端口
        ...
        , toolbars:[
            ['fullscreen','source', '|', 'undo', 'redo', '|',
                ...
                'insertimage', 'insertframe', 'pagebreak', 'template', 'background', '|',
...
//          ]
        ...
        //当设置为[]时，编辑器将关闭自定义的右键菜单功能，即可正常使用右键进行copy、paste modify by yaohuiye on 20140311
        ,contextMenu:[
//            {
//                label:'',       //显示的名称
