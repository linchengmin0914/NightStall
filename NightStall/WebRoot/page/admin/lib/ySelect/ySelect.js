    ...
    $.fn.ySelect = function (options) {
        ...
        ySelect.prototype = {
            create: function () {
                ...
                this.$select.wrap('<div class="fs-wrap' + multiple + '" data-ischeck="' + settings.isCheck +'" style="width:100%"></div>');
            ...
            reload: function () {
                if (this.settings.showSearch) {
                    var search = '<div class="fs-search"><input type="search" style=' + (this.settings.showAll ? "" :"width:100%")+' placeholder="' + this.settings.searchText + '" />';
